...
export const products: Product[] = [
  ...
  },
  {
    ...
    ar: {
      ...
      benefits: [
        "تعالج المستندات 10 أسرع من الإدخال اليدوي",
        "دقة 99%+ على المستندات المنظمة",
        "ت eliminate أخطاء إدخال البيانات البشرية",
  ...
  },
  {
    ...
    ar: {
      ...
      useCases: [
        ...
        "مراقبة الامتثال لسلامة מקום العمل",
  ...
  },
  {
    ...
    ar: {
      ...
      useCases: [
        ...
        "إدارة أنبوب مبيعات المبيعات والمتابعة",
  ...
  },
  {
    ...
    en: {
      ...
      useCases: [
        ...
        "HR policy问答 and employee self-service",
    ...
    ar: {
      ...
      description: "نظام توليد معزز بالاسترجاع يجعل مستنداتك وسياساتك وقواعد معرفتك الخاصة قابلة للبحث والمحادثة. يجمع MovinSearch بين البحث المتجه وبرمجة نماذج اللغة الكبيرة لتقديم إجابات دقيقة وموثقة م.handleError في بيانات مؤسستك.",
      features: [
        "تقسيم وتضمين تلقائي للمستندات",
        "بحث هجين: دلالي + كلمات مفتاحية + بيانات وصفية",
        "إشارات مصدرية مع مراجع الصفحة/القسم",
        "تحكم في الوصول على basis الدور للبيانات الحساسة",
      ...
      benefits: [
        "يجد الموظفون المعلومات 5 أسرع من البحث اليدوي",
        "يeliminate الأسئلة المتكررة لخبراء الموضوع",
